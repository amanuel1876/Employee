                    ...
                    <div className="row">
                        <div className="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                                        ...
                                        <div className="form-group">
                                            <div className="d-block">
                                                ...
                                                <div className="float-right">
                                                    <NavLink to='/forgot' className="text-small">Forgot Password?</NavLink>
                                                </div>
                                            </div>
                                            <input
                                                id="password"
                            ...
                            <div className="simple-footer">
                                Developed by Amanuel Desalegn
                                <a className="mt-5 ml-2" target="_blank" rel="noopener noreferrer" href="https://github.com/amanuel1876">
                                ...
                                <a className="ml-2" href="https://www.linkedin.com/in/amanuel-desalegn-862220297/" target="_blank" rel="noopener noreferrer">
                                ...
                                <a className="ml-2" href="https://github.com/amanuel1876" target="_blank" rel="noopener noreferrer">
